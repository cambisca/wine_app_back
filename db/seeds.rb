...
Wine.create(name: "You Are My Sunshine", classification: "Rosé", year: 2020, varietal: "Verjus, Piquette Blanc, Piquette Rouge", review: "Fizzy, fun, and yummy!", image_url: "https://cdn.shopify.com/s/files/1/0011/8148/3072/products/you-are-my-sunshine-old-westminster-natural-Rose-Piquette-wine-Maryland-USA-front_1296x.jpg?v=1611071646", vibe: "Party")
Wine.create(name: "Metamorphika", classification: "Orange", year: 2019, varietal: "Sumoll Blanc", review: "A savoury orange wine with a distinct mediterranean flair.", image_url: "https://cdn.shopify.com/s/files/1/0011/8148/3072/products/metamorphika-sumoll-orange-costador-natural-White0Orange-wine-Catalunya-Spain-front_1512x.jpg?v=1611071802", vibe: "Me time")
...
Wine.create(name: "The Electric Chardonnay Acid Test", classification: "White", year: 2019, varietal: "Chardonnay, Riesling", review: "This is the anti-Chardonnay, Chardonnay!", image_url: "https://cdn.shopify.com/s/files/1/0011/8148/3072/products/the-electric-chardonnay-acid-test-brand-natural-white-wine-pfalz-germany-front_1512x.jpg?v=1611148576", vibe: "Me time")
Wine.create(name: "Pampaneo Ancestrale", classification: "White", year: 2019, varietal: "Airen", review: "This pét-nat is playful and bubbly!", image_url: "https://cdn.shopify.com/s/files/1/0011/8148/3072/products/Pampaneo-Ancestrale-Esencia-Rural_900x.png?v=1611760068", vibe: "TGIFF")
Wine.create(name: "Malas Uvas Blanco", classification: "White", year: 2019, varietal: "Palomino, Doña Blanca", review: "Bright acid met with a lovely texture that is savoury!, A fresh and gluggable wine! ", image_url: "https://cdn.shopify.com/s/files/1/0011/8148/3072/products/malas-uvas-blanco-la-perdida-natural-white-wine-galicia-spain-front_900x.jpg?v=1611759722", vibe: "Feast")
...
Wine.create(name: "Prosa", classification: "Rosé", year: 2019, varietal: "Pinot Noir, St. Laurent, Zweigelt, Blaufränkisch", review: "A lovely sparkling rose from a blend thats full of fresh red berries and florals!", image_url: "https://cdn.shopify.com/s/files/1/0011/8148/3072/products/prosa-meinklang-natural-sparkling-rose-wine-hungary-front_900x.jpg?v=1611756958", vibe: "TGIFF")
Wine.create(name: "Listan", classification: "Red", year: 2019, varietal: "Listan Prieto", review: "To be enjoyed with grilled game, peppered beef or foods rich in umami!", image_url: "https://cdn.shopify.com/s/files/1/0011/8148/3072/products/Listan-Bichi_5595f6c6-609f-4fbc-a682-608231a5405a_900x.png?v=1611757834", vibe: "Me time")
Wine.create(name: "Pet Mex", classification: "Rosé", year: 2019, varietal: "Unidentified", review: "This sparkling rose is both fresh and vibrant, with notes of strawberry, citrus and raspberry!", image_url: "https://cdn.shopify.com/s/files/1/0011/8148/3072/products/pet-mex-bichi-natural-sparkling-rose-wine-baja-clifornia-mexico-front_900x.jpg?v=1611069202", vibe: "Feast")
...
Food.create(pairing: "chicken", wine_id: 6)
Food.create(pairing: "beef", wine_id: 7)
Food.create(pairing: "scallops", wine_id: 8)
Food.create(pairing: "pasta", wine_id: 9)
Food.create(pairing: "chicken", wine_id: 10)
Food.create(pairing: "chicken", wine_id: 11)
Food.create(pairing: "beef", wine_id: 12)
Food.create(pairing: "scallops", wine_id: 13)
Food.create(pairing: "pasta", wine_id: 14)
Food.create(pairing: "chicken", wine_id: 15)
Food.create(pairing: "chicken", wine_id: 16)
Food.create(pairing: "chicken", wine_id: 17)
Food.create(pairing: "beef", wine_id: 18)
Food.create(pairing: "scallops", wine_id: 19)
Food.create(pairing: "pasta", wine_id: 20)
Food.create(pairing: "chicken", wine_id: 21)
Food.create(pairing: "chicken", wine_id: 22)
Food.create(pairing: "chicken", wine_id: 23)
Food.create(pairing: "beef", wine_id: 24)
